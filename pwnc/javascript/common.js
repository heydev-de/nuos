...
function clipboard_write(text)
{
    ...
    try { status = document.execCommand("copy"); } catch (exception) {};
...
function str2utf8bin(string)
{
    return String.fromCodePoint(...(new TextEncoder()).encode(string));
};
