...
## Version 26.9.23.8 (2026-09-23 21:06)

* Highlight onboarding instructions

---

## Version 26.9.23.7 (2026-09-23 20:54)

* Add timezone-aware welcome time

---

## Version 26.9.23.6 (2026-09-23 20:38)

* Improve MCP onboarding and export support

---

## Version 26.9.23.5 (2026-09-23 20:14)

* Use in-memory cache for data files

---

## Version 26.9.23.4 (2026-09-23 16:23)

* Capture raw OpenRouter errors
* Fix provider chat endpoints
* Add message fallback for agent errors

---

## Version 26.9.23.1 (2026-09-23 12:32)

* Fix cms_permission call for interface.agent

---

## Version 26.9.23.0 (2026-09-23 11:01)

* Bind agent context to form element

---

## Version 26.9.22.7 (2026-09-22 23:03)

* Add New action to agent popovers

---

## Version 26.9.22.6 (2026-09-22 22:35)

* Fix null ID handling in agent display

---

## Version 26.9.22.4 (2026-09-22 21:35)

* Add agent context handling and UI
* Add --ifc-open-agent-size CSS variable
* Preserve existing translations during t() scan
* Add AI agent button to interface

---

## Version 26.9.22.0 (2026-09-22 10:45)

* Fix MCP instruction counter logic

---

## Version 26.9.21.15 (2026-09-21 21:26)

* Fix agent message and MCP result handling
* Refactor MCP init and skip provider-answered calls
* Support custom MCP tool names
* Track tool metadata across agent messages

---

## Version 26.9.21.11 (2026-09-21 15:30)

* Update ifc.js

---

## Version 26.9.21.9 (2026-09-21 15:12)

* Format clipboard JSON and bind IFC command this

---

## Version 26.9.21.8 (2026-09-21 13:56)

* Resume agent context after MCP calls
* Use keydown and prevent default on Enter
* Add call_reply tool metadata and handler
* Add synthetic tool-call relay for agent calls
* Clarify wording for call responses
* Clarify external call tool behavior
* Namespace agent daemon keys by owner/user
* Rename run terminology to chat/context
* Fix agent run ID continuity
* Use session cookies for CMS auth
* Remove X-Frame-Options and HSTS from .htaccess
* Set SameSite to Strict and cookie expiry
* Use permission helper and fix cookie expiry
* Fix MCP agent call message
* Set cookie expiration to 1 hour instead of session
* Show permission name in call message
* Clarify MCP follow-up messaging
* Improve agent list and code wrapping
* Improve multiline code wrapping
* Clarify agent handoff messaging
* Expose object param and refine agent UI
* Clarify agent follow-up messaging
* Clarify 'call' description and add warning
* Fix run ID messaging
* Refine callback handling and MCP resources
* Clarify MCP run-id message
* Fix MCP callback auth handling
* Fix agent run callbacks and token deletion
* Use callback for agent calls; fix token ops
* Use data for permission tokens; add reply delivery
* Rename wake_up to call; support owner & id
* Use --ifc-color-bg-related for agent response
* Add agent reasoning capture and UI
* Fix agent markdown rendering and config
* Add fallback error paths for agent responses
* Improve speech recognition lifecycle
* Fix response parsing and permission form fields
* Add Poolside agent JSON and simplify checks
* Add Google OpenAI agent and markdown polish
* Integrate marked.js for agent Markdown
* Remove markdown parser and adjust customer perms
* Fix agent permissions, markdown, JS and UI issues
* Use run_stop result and return finish flag
* Handle deferred agent deletion
* Report speech recognition errors to UI
* Fix speech button sizing and detection
* Fix speech recognition availability flow
* Improve speech recognition availability handling
* Add speech recognition UI and assets
* Use MinHeap and show 100 recent agents
* Allow agent tool responses without reply
* Harden overflow detection patterns
* Update agent prompt labels
* Validate agent replies and update icons
* Broaden overflow detection for agents
* Agent UI, markdown, and error handling improvements
* Refactor agent UI, add commands and assets
* Improve agent tool-call UI
* Add agent icon and improve agent display
* Enhance agent interface and messaging
* Incremental agent display loading and scroll
* Add agents UI, provider text mappings and icons

---

## Version 26.9.15.6 (2026-09-15 06:23)

* Skip no-op message compaction
* Fix agent overflow and compaction limits
* Refactor agent user prompts and stop flow
* Handle corrupted agent context
* Update lib.agent.inc
* Refactor agent run flow and provider endpoints
* Scope agent contexts by owner

---

## Version 26.9.14.11 (2026-09-14 14:09)

* Clarify memory tool semantics
* Group MCP fields and add request comment
* Trim repeated request context and auth prompts
* Improve system prompts & permission name handling
* Remove X-Frame-Options header
* Add tagged token generation and validation
* Guard daemon creation with cms_load('agent')
* Exclude .htaccess from MCP bundle
* Relocate PWNC skill manuals
* Move MCP files under mcp/resources and update paths
* Rename agent templates to JSON path
* Add wake_up tool and agent run-id handling
* Fix agent config and list handling
* Fix optional tool schema handling
* Refactor MCP client request flow
* Fix MCP header parsing edge cases
* Add AI agent provider support

---

## Version 26.9.11.2 (2026-09-11 06:02)

* Harden location validation and secure randomness
* Add current host to generated host list
* Enforce approved host list

---

## Version 26.9.10.2 (2026-09-10 02:05)

* Disallow additionalProperties in MCP schemas

---

## Version 26.9.10.1 (2026-09-10 00:56)

* Reset content range defaults

---

## Version 26.9.10.0 (2026-09-10 00:20)

* Lower MCP response limit

---

## Version 26.9.9.10 (2026-09-10 00:11)

* Add filter_context property and align properties
* Fix response filtering with ranges

---

## Version 26.9.9.8 (2026-09-09 15:31)

* Add filtered response retrieval

---

## Version 26.9.9.7 (2026-09-09 10:01)

* Stop capturing whitespace in image tag regex
* Restore document defaults before caching
* Preserve and grow repeat defaults
* Fix repeat default handling
* Polish empty dropdown visuals and timing
* Initialize repeat defaults correctly
* Pre-seed repeat slots when shifting elements
* Fix repeat slot logic and password encoding
* Update lib.template.inc
* Fix repeat defaults for dynamic children

---

## Version 26.9.8.5 (2026-09-08 09:53)

* Use $_diff variable and refine truncation message

---

## Version 26.9.8.4 (2026-09-08 09:36)

* Document mcp static properties
* Truncate oversized MCP responses (max_length)
* Add get_response with line-range support

---

## Version 26.9.8.1 (2026-09-08 04:00)

* Fix IFC logo and download links

---

## Version 26.9.8.0 (2026-09-08 03:35)

* Add nuos redirect entrypoint

---

## Version 26.9.7.12 (2026-09-07 18:45)

* Force message save during retrieve
* Add null guard for $this->file in defer check

---

## Version 26.9.7.10 (2026-09-07 17:52)

* Fix drag/drop selector quoting

---

## Version 26.9.7.7 (2026-09-07 13:38)

* Fix repeat bookkeeping and docs
* Fix template repeat pinning

---

## Version 26.9.7.5 (2026-09-07 11:01)

* Fix filemanager path handling for recursion

---

## Version 26.9.7.4 (2026-09-07 09:59)

* Clarify template docs
* Add auto-repeat and auto-id improvements
* Pass version to retrieval handler
* Add whois MCP tool and permission helpers

---

## Version 26.9.7.0 (2026-09-07 00:59)

* Say what a plugin value is
* Mark the shift element as legacy

---

## Version 26.9.6.3 (2026-09-06 20:48)

* Use lax SameSite cookies

---

## Version 26.9.6.2 (2026-09-06 03:51)

* Harden .htaccess: block indexes, dot paths, headers

---

## Version 26.9.6.0 (2026-09-06 03:40)

* Remove extra blank line in system messages

---

## Version 26.9.6.0 (2026-09-06 02:37)

* Improve language URLs and harden headers

---

## Version 26.9.5.6 (2026-09-05 23:44)

* Add MCP client bundle and bridge
* Add Windows retry logic to rename
* Fix bridge log and IFC download string
* Normalize MCP header casing and tidy bridge.js
* Track deferred data across file ops
* Update sys.mcp.inc
* Use innerHTML instead of textContent for mcp label

---

## Version 26.9.4.0 (2026-09-04 01:47)

* Accept combined memory id (region/number)
* Add memory management and DB fix
* Add memory skill guide and cleanup
* Clarify MCP memory and defaults
* Fix MCP content payload field
* Improve memory mnemonic indexing and permissions
* Memory: tools, attachments, and cleanup daemon
* Normalize error messages and memory formatting
* Only reposition activation link for link types
* Refactor memory sorting and mcp outputs
* Refine memory handling and DB schema
* Rename memory 'area' to 'region' throughout
* Update lib.memory.inc
* Update pwnc.inc
* Validate follow-up dates and memory changes

---

## Version 26.9.1.0 (2026-09-01 03:26)

* mcp: add diff budget, limits and cache expiry
* Reduce MCP diff payload size

---

## Version 26.8.31.5 (2026-08-31 03:54)

* Add response diffing and full response access
* Apply HTML tag line-break only when diffing
* Clarify mcp_diff comments and naming
* Fix diff comments and cache key
* Fix MCP diff URL fallback logic
* Mark MCP responses as non-success
* mcp: binary/html handling and proxy script
* Normalize request path and refactor response
* Refine MCP diff algorithm and remove dead code

---

## Version 26.8.29.19 (2026-08-29 23:51)

* Add JSON flag and refactor template editor
* Fix template activation links
* Refactor image() outputs and add image_data()
* Refactor template drag/drop and content JS
* Refactor template drag/drop metadata
* Refactor template editor rendering and JS
* Use image() helper with sizes; fix edit_display check

---

## Version 26.8.29.9 (2026-08-29 07:21)

* Clarify MCP entry; fix header and error
* Clarify MCP target_url usage
* Delay urlencode($prefix) until saving files
* Fallback to local HTTP handler on bad target
* Fix file upload encoding and temp handling
* Fix HTTP and MIME parameter quoting
* Fix HTTP multipart uploads
* Fix HTTP status parsing and header forwarding
* Fix MCP form schema syntax
* Fix nested form field serialization
* Forward HTTP headers in MCP responses
* Handle HTTP error responses consistently
* Optimize HTTP multipart memory usage
* Populate $_POST/$_FILES from form_data input
* Prefer filename key and detect MIME type
* Refactor HTTP lib and add MCP http module
* Refactor MCP form handling and HTTP utilities
* Refresh PWNC MCP docs
* Remove transposed comment in sys.mcp.inc
* Update license.txt

---

## Version 26.8.26.3 (2026-08-26 19:22)

* Add tabindex to delete buttons
* Add time-based greeting to IFC UI
